...
function getLocalizedFallbackSeo(readableName, locale) {
  if (locale === 'he') {
    return {
      title: `${readableName} מומלצים באזור שלכם | Hiro`,
      description: `מצאו ${readableName} מומלצים ב-Hiro, השוו פרופילים, ביקורות וזמינות ובחרו בעל מקצוע מתאים בקלות.`,
      intro: `מצאו ${readableName} מומלצים באזור שלכם והשוו פרופילים, ביקורות וזמינות ב-Hiro.`,
      keywords: readableName ? [readableName, `${readableName} לידכם`, 'בעלי מקצוע', 'שירותים לבית'] : ['בעלי מקצוע', 'שירותים לבית'],
    };
  }

  if (locale === 'ar') {
    return {
      title: `${readableName} بالقرب منكم | Hiro`,
      description: `اعثروا على ${readableName} الموثوقين في Hiro، وقارنوا الملفات الشخصية والتقييمات والتوفر بسهولة.`,
      intro: `اعثروا على ${readableName} بالقرب منكم وقارنوا الملفات الشخصية والتقييمات والتوفر في Hiro.`,
      keywords: readableName ? [readableName, `${readableName} بالقرب منكم`, 'مهنيون محليون', 'خدمات منزلية'] : ['مهنيون محليون', 'خدمات منزلية'],
    };
  }
